...
import sys
sys.path.append('../')
from constants import thesis_font, a4_textwidth, a4_textheight, beamer_font, beamer_textwidth, beamer_textheight
...
ax0.hlines(y = 0.0633, xmin=0, xmax=47.5, color="red", label="0.0633\%")
ax0.hlines(y = 0.00633, xmin=0, xmax=47.5, color="magenta", label="0.00633\%")

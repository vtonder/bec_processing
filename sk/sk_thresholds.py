...
sigma3 = 3 * np.sqrt(4 / M)  # approximate 3 sigma lines
...
plt.semilogy(x, cdf, label="CDF", linewidth=2)
plt.semilogy(x, cdf2, label="CCDF", linewidth=2)
plt.axhline(pfa3s, color='r', linewidth=2, label="PFA")
plt.axvline(1 + sigma3, color='g', linewidth=2, linestyle='--', label="$1\pm3\sqrt{4/M}$ threshold")
plt.axvline(1 - sigma3, color='g', linewidth=2, linestyle='--')
plt.axvline(0.77511, color='g', linewidth=2, linestyle='-', label="Pearson type IV threshold")

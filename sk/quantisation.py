...
from constants import a4_textwidth, a4_textheight, thesis_font, beamer_font, beamer_textheight, beamer_textwidth
...
x_labels = ["$-3\sigma$", "$-2\sigma$", "$-1\sigma$", "$0\sigma$", "$1\sigma$", "$2\sigma$", "$3\sigma$"]
...
ax.set_ylabel("PDF")
ax.set_xlim([-3.5, 3.5])
ax.set_xticks(x_range, x_labels)
ax.legend()
plt.savefig('/home/vereese/Documents/PhD/Thesis/Figures/quant_raw_v.pdf', transparent=True, bbox_inches='tight')
#plt.savefig('/home/vereese/Documents/PhD/presentation/quant_raw_v.pdf', transparent=True, bbox_inches='tight')
...
ax1.legend()
plt.savefig('/home/vereese/Documents/PhD/Thesis/Figures/quant_sk.pdf', transparent=True, bbox_inches='tight')
#plt.savefig('/home/vereese/Documents/PhD/presentation/quant_sk.pdf', transparent=True, bbox_inches='tight')
plt.show()

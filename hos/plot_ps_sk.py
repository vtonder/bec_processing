...
sp1x = np.load('ps_M512_1234_0x.npy')
sp2x = np.load('ps_M1024_1234_0x.npy')
sp3x = np.load('ps_M2048_1234_0x.npy')

spy = np.load('ps_1234_0y.npy')
sp1y = np.load('ps_M512_1234_0y.npy')
sp2y = np.load('ps_M1024_1234_0y.npy')
sp3y = np.load('ps_M2048_1234_0y.npy')

#sp4x = np.load('./lower_1024/mpi_ps_M1038_1234_0x.npy')
#sp5x = np.load('./lower_1024/mpi_ps_M2076_1234_0x.npy')

#sp1y = np.load('./lower_1024/mpi_ps_1234_0y.npy')
#sp2y = np.load('./lower_1024/mpi_ps_M519_1234_0y.npy')
#sp3y = np.load('./lower_1024/mpi_ps_M1557_1234_0y.npy')
#sp4y = np.load('./lower_1024/mpi_ps_M1038_1234_0y.npy')
#sp5y = np.load('./lower_1024/mpi_ps_M2076_1234_0y.npy')
...
plt.figure(1)
plt.plot(p, label='No mitigation')
plt.plot(p1, label='M=512')
...
plt.figure(2)
plt.imshow(spy,aspect='auto',origin='lower')
plt.title('no rfi mitigation')

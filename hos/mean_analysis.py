...
parser.add_argument("-e", "--std_error", dest="std_error", help="Compute the standard error of the mean estimate of each sample")
parser.add_argument("-m", "--median", dest="median", help="Compute the median of each set")
parser.add_argument("-v", "--variance", dest="var", help="Compute the variance of each set")
parser.add_argument("-o", "--outlier_detection", dest="outlier", help="Conduct 3 sigma outlier test")

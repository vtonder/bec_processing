...
# 1 sigma PFA total, 0.5 sigma towards lower and 0.5 towards upper
...
# 2 sigma PFA, 1 sigma towards lower and 1 towards upper
...
# 2.5 sigma PFA, 1.25 sigma towards lower and 1.25 towards upper
...
# SK lower and upper limits for PFA = 0.267% (3sigma). Obtained using sk/sk_thresholds.py script

...
parser.add_argument("-l", dest = "low", help = "Lower threshold to use. defined in constants file. map in get_lower_limit in common.py. options: 1s, 2s, 2_5s, 3s, 4s, 2p, skmin", default = None)
